...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2015 at 06:14 PM
...
INSERT INTO `t_area` (`A_ID`, `A_NOMBRE`) VALUES
(1, 'test');
...
CREATE TABLE IF NOT EXISTS `t_contrato` (
  `CON_NUMERO` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `CON_CALIFICACION` int(11) DEFAULT NULL,
...
INSERT INTO `t_contrato` (`CON_NUMERO`, `CON_FECHA_INI`, `CON_FECHA_FIN`, `CON_CONSULTORIA`, `CON_MONTO`, `CON_PAIS`, `USU_ID`, `EMP_RUC`, `PER_ID`, `PROY_ID`, `CON_LINK`, `CON_FECHA_FIRMA`, `CON_CALIFICACION`) VALUES
(2, '2015-06-10', '2015-06-11', 'yydtfgj', 45, 'ftgdcth', 0, NULL, 1721531950, 1, NULL, '2015-06-11', NULL);
...
CREATE TABLE IF NOT EXISTS `t_persona` (
  ...
  `PER_PROFESION` varchar(200) DEFAULT NULL,
  `PER_TELEFONO` varchar(200) DEFAULT NULL,
  `PER_CIUDAD` varchar(200) DEFAULT NULL,
  `PER_PAIS` varchar(200) DEFAULT NULL,
  `PER_CARGO` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`PER_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1721531951 ;
...
INSERT INTO `t_proyecto` (`PROY_ID`, `PROY_NOMBRE`, `A_ID`) VALUES
(1, 'test', 1);
...
INSERT INTO `t_usuario` (`USU_ID`, `USU_NOMBRE`, `USU_MAIL`) VALUES
...
`Numero de contrato` int(11)
,`Fecha de firma` date
,`Nombre Contratista` varchar(401)
