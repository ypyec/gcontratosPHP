...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2015 at 06:40 AM
...
(2, '2015-06-10', '2015-06-11', 'yydtfgj', 45, 'ftgdcth', 1, NULL, 1721531950, 1, NULL, '2015-06-11', NULL);
...
CREATE TABLE IF NOT EXISTS `t_persona` (
  ...
  PRIMARY KEY (`PER_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1721531952 ;
...
,`Especializaci&oacuten Contratista` varchar(200)
,`Consultoria` varchar(200)
,`Fecha de Inicio` date
,`Fecha de Fin` date
,`Honorarios` double
,`Pais de ejecuci&oacuten` varchar(200)
...
ALTER TABLE `t_contrato`
  ADD CONSTRAINT `t_contrato_ibfk_5` FOREIGN KEY (`USU_ID`) REFERENCES `t_usuario` (`USU_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `t_enmienda`
  ADD CONSTRAINT `t_enmienda_ibfk_3` FOREIGN KEY (`USU_ID`) REFERENCES `t_usuario` (`USU_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
