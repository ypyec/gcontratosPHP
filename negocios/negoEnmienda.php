...
class NegoEnmienda
{
    ...
    function __construct($id = null, $numero = null, $fechaFin = null, $consultoria = null,
        $monto = null, $link = null, $usuario = null, $contrato = null, $descripcionX = null,
    ...
    public function crearEnmienda()
    {
        ...
        return datosEnmienda::crearEnmienda($this->numero, $this->fechaFin, $this->
            consultoria, $this->monto, $this->fechaFirma, $this->usuario, $this->contrato, $this->
            link);
    }
