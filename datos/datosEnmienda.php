...
class datosEnmienda {
    ...
    public static function crearEnmienda($numero, $fechaFin, $consultoria, $monto, $fechaFirma, $usu_ID, $con_Numero, $link=null) {
    ...
    public static function totalEnmiendas($con_Numero) {
        ...
        $sql = "SELECT count(ENM_NUMERO) as 'Numero de Enmiendas' FROM T_ENMIENDA WHERE CON_NUMERO = '".$con_Numero."'";
