...
class datosPersona
{
    ...
    public static function crearPersona($id, $nombres, $apellidos, $profesion, $telefono,
        $ciudad, $pais, $cargo)
    {
    ...
    public static function actualizarPersona($id, $nombres, $apellidos, $profesion,
        $telefono, $ciudad, $pais, $cargo)
    {

        $sql = "UPDATE T_PERSONA SET PER_NOMBRE='" . $nombres . "',PER_APELLIDO='" . $apellidos .
            "',PER_PROFESION='" . $profesion . "',PER_TELEFONO='" . $telefono .
            "',PER_CIUDAD='" . $ciudad . "',PER_PAIS='" . $pais . "',PER_CARGO='" . $cargo .
            "' WHERE PER_ID='" . $id . "'";
